    ...
    export const CustomOption = (props) => {
        ...
        return (
            <components.Option   {...props}>
                <div className={`flex items-center justify-between w-full text-sm relative z-[999999] ${props.isDisabled ? "cursor-default" : "cursor-pointer"}`}>
    ...
    export const CustomMenuList = (props) => {
        return (
            <Customscrollbar className='max-h-[300px] relative z-[9999]'>
                {props.children}
            </Customscrollbar>
        )
    }
