            ...
            sub: [
                {
                    ...
                    items: [
                        ...
                        // },
                        {
                            ...
                            link: "/report-statistical/sales_report/quote",
                        },
                        {
                            viewOwn: -1,
                            view: -1,
                            name: "Báo cáo mua hàng",
                            link: "/report-statistical/purchase_report/purchases",
                        },
                        {
                            viewOwn: -1,
                            view: -1,
                            name: "Công nợ phải thu",
                            link: "/report-statistical/receivables_debt/aggregate_debt",
                        },
                        {
                            viewOwn: -1,
                            view: -1,
                        ...
                        },
                        {
                            ...
                            view: -1,
                            name: "Tồn quỹ",
                            link: "/report-statistical/fund-balance/autumn_diary",
                        },
                        {
                            viewOwn: -1,
                            view: -1,
                            name: "Tồn kho",
                            link: "/report-statistical/warehouse_report/card",
                        },
                        {
                            viewOwn: -1,
                            view: -1,
                            name: "Quản lý sản xuất",
                            link: "/report-statistical/production_manager/quota_materials",
                        },
                        {
                            viewOwn: -1,
                            view: -1,
                            name: "Báo cáo lợi nhuận",
                            link: "/report-statistical/profit_report",
                        },
                    ],
                },
            ],
            ...
            sub: [
                {
                    ...
                    items: [
                        ...
                        {
                            viewOwn: auth?.customer - debt?.is_view_own,
                            view: auth?.customer - debt?.is_view,
