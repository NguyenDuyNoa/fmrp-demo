        ...
        >
            <div className="3xl:w-[1000px] 3xl:max-w-[1100px] 3xl:h-[600px] w-[800px] max-w-[900px] h-[500px] grid grid-cols-2 bg-white rounded-xl relative">
                <MdClose
                    ...
                    className="absolute top-4 right-4 text-2xl cursor-pointer text-[#000000] hover:text-[#000000]/80 hover:scale-105 duration-300 transition-colors"
                />
                        ...
                        <div className=" flex flex-col gap-6">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <h1 className="col-span-9 pb-2  text-gray-700 font-semibold text-[14px] text-ju">
                                    ...
                                    đến với FMRP! Hãy dành thời gian để khám phá các tính năng hữu ích mà FMRP mang lại
                                    nhé.
                                </h1>
                            </div>
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <h2 className=" py-1 text-gray-700 font-semibold text-[14px]">
                                    FMRP mong rằng bạn sẽ tìm được giải pháp hiệu quả cho quá trình quản lý sản xuất của
                                    doanh nghiệp bạn.
                                </h2>
                            </div>
