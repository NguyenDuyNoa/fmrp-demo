...
export default function Loading(props) {
    return (
        <div className={"relative bg-slate-50/50 w-full 3xl:h-[516px] 2xl:h-[356px] xl:h-[286px] h-[352px] flex flex-col justify-center items-center rounded " + props.className}> 
