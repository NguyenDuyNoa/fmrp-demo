        ...
        <div className="3xl:mt-48 2xl:mt-32 xl:mt-32 mt-36 ">
          <div className={`${deca.className} bg-[#ffffff] p-4 shadow-xl rounded-xl`}>
            <div className="flex justify-between items-center">
              <h1 className="text-[#101828] font-medium 3xl:text-[22px] 2xl:text-[18px] text-lg">{props.title}</h1>
              <button onClick={props.onClose} className="outline-none w-7 h-7 bg-slate-200 hover:opacity-80 hover:scale-105 transition rounded-full flex flex-col justify-center items-center">
