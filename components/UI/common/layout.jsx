...
export const Container = ({ children, className }) => {
    return <div className={`${className} 3xl:pt-[88px] 2xl:pt-[74px] xl:pt-[60px] lg:pt-[60px] 3xl:px-6  2xl:px-4 xl:px-4  px-4  space-y-1 overflow-hidden h-screen`}>
        {children}
    </div>
}
...
export const ContainerTable = ({ children }) => {
    return (
        <div className="space-y-2 3xl:h-[92%] 2xl:h-[90%] xl:h-[98%] lg:h-[90%] overflow-hidden">
            {children}
        </div>
    )
}