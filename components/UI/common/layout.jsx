...
export const Container = ({ children, className }) => {
    return <div className={`${className} pt-[72px] 3xl:px-6 2xl:px-4 xl:px-4 px-4 3xl:space-y-2 space-y-1 overflow-hidden h-screen`}>
...
export const ContainerTable = ({ children }) => {
    return (
        <div className="h-full ">
            {/* <div className="space-y-2 3xl:h-[90%] 2xl:h-[84%] xl:h-[84%] lg:h-[86%] "> */}
            {children}
        </div>
    )
}
    ...
    return (
        <>
            ...
            <Container>
                {breadcrumb}
                <ContainerBody>
                    <div className="space-y-0.5 overflow-hidden flex flex-col ">
