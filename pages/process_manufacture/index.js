        ...
        <React.Fragment>
            ...
            <div className='3xl:px-10 3xl:pt-16 3xl:pb-3 2xl:pt-[70px] xl:px-10 px-3 pt-16 pb-3 space-y-1 lg:h-screen overflow-hidden flex flex-col justify-between'>
                ...
                <div className='3xl:h-[100%] 2xl:h-[100%] xl:h-[100%] lg:h-[84%] w-[100%] 3xl:px-[55px] 2xl:px-12 2xl:pt-1 lg:pt-2 relative border-2 border-slate-100 overflow-hidden flex-col flex'>
                        ...
                        <div class="basis-full">
                            <div className='3xl:w-[180px] 2xl:w-[100px] xl:w-[100px] lg:w-[80px] flex justify-center'>
                                <div className=' 3xl:h-[80px] 3xl:w-[80px] 2xl:h-[60px] 2xl:w-[60px] xl:h-[48px] xl:w-[48px] lg:h-[44px] lg:w-[44px] rounded-full flex flex-col justify-center items-center bg-[#3276FA] text-white'>
                                    <h5 className='3xl:text-[16px] 2xl:text-[12px] xl:text-[10px] lg:text-[8px] text-center'>Bắt đầu</h5>
                                </div>
                            </div>

                            <div className='3xl:w-[180px] 2xl:w-[100px] xl:w-[100px] lg:w-[80px] flex justify-center'>
                                <div className='3xl:h-14 2xl:h-10 xl:h-8 lg:h-9 flex flex-col justify-center items-center '>
                                    <div className="relative">
                                        <IconRight size='24' className="bottom-[0%] 3xl:-translate-x-[44%] 3xl:translate-y-[25%] 3xl:scale-150 2xl:-translate-x-[44%] 2xl:translate-y-[26%] 2xl:scale-125 xl:-translate-x-[44%] xl:translate-y-[30%] xl:scale-110 lg:-translate-x-[46%] lg:translate-y-[30%] lg:scale-105 text-[#3276FA] absolute rotate-90" />
                            ...
                            <div className='flex'>
                                <div>
                                    <div className="flex items-center space-1">
                                        ...
                                        <div className='3xl:w-14 2xl:w-12 xl:w-10 lg:w-9 flex flex-col justify-center items-center '>
                                            <div className="flex items-center 3xl:-space-x-[20px] xl:-space-x-[17px] lg:-space-x-5">
                                                ...
                                                <IconRight size='24' className="text-[#3276FA] 3xl:scale-150 2xl:scale-110 xl:scale-100 lg:scale-90" />
                                            </div>
                                        </div>
                                        ...
                                        <div className='flex justify-center items-center relative'>
                                            ...
                                            <div className="flex items-center 3xl:-space-x-[18px] lg:-space-x-4 absolute 3xl:-top-[255%] 3xl:left-[365%] 2xl:-top-[265%] 2xl:left-[430%] xl:-top-[270%] xl:left-[420%] lg:-top-[300%] lg:left-[490%]">
                                                ...
                                                <IconRight size='24' className="text-[#B2B9C8] 3xl:scale-150 2xl:scale-110 xl:scale-95 lg:scale-90" />
                                            </div>
                                            ...
                                            <div className='3xl:w-[200px] 2xl:w-[200px] xl:w-[130px] lg:w-[130px] 3xl:top-[130%] 3xl:left-[485%] 2xl:top-[130%] 2xl:left-[470%] xl:top-[120%] xl:left-[570%] lg:top-[140%] lg:left-[520%] flex justify-center absolute'>
                                                <div className='3xl:h-14 2xl:h-12 xl:h-10 lg:h-9 flex flex-col justify-center items-center '>
                                                    <div className="relative">
                                                        <IconRight size='24' className=" top-0 3xl:-translate-x-[46%] 3xl:-translate-y-[20%] 3xl:scale-150 2xl:-translate-x-[47%] 2xl:translate-y-[-30%] 2xl:scale-125 xl:-translate-x-[46%] xl:-translate-y-[32%] xl:scale-125 lg:-translate-x-[45%] lg:-translate-y-[34%] lg:scale-110 text-[#B2B9C8] absolute -rotate-90" />
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className='3xl:w-[220px] 2xl:w-[200px] xl:w-[130px] lg:w-[130px] flex justify-center'>
                                        <div className='3xl:h-[52px] 2xl:h-[38px] xl:h-[32px] lg:h-9 flex flex-col justify-center items-center '>
                                            <div className="relative">
                                                <IconRight size='24' className="bottom-[0%] 3xl:-translate-x-[44%] 3xl:translate-y-[24%] 3xl:scale-150 2xl:-translate-x-[45%] 2xl:translate-y-[28%] 2xl:scale-125 xl:-translate-x-[44%] xl:translate-y-[30%] xl:scale-110 lg:-translate-x-[45%] lg:translate-y-[30%] lg:scale-110 text-[#3276FA] absolute rotate-90" />
                                    ...
                                    <div className='3xl:w-[220px] 2xl:w-[200px] xl:w-[130px] lg:w-[130px] flex justify-center'>
                                        <div className=' 3xl:h-[80px] 3xl:w-[80px] 2xl:h-[60px] 2xl:w-[60px] xl:h-[48px] xl:w-[48px] lg:h-[44px] lg:w-[44px] rounded-full flex flex-col justify-center items-center bg-[#3276FA] text-white'>
                                            <h5 className='3xl:text-[16px] 2xl:text-[12px] xl:text-[10px] lg:text-[8px] text-center'>Kết thúc</h5>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <Image alt="" src="/process/Logo-BG.png" width={1200} height={420} className="3xl:w-[600px] 2xl:w-[450px] xl:w-[350px] lg:w-[350px] left-[2%] bottom-[8%] absolute select-none pointer-events-none object-contain " loading="lazy" crossOrigin="anonymous" placeholder="blur" blurDataURL="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" />
                </div>
            </div>
        </React.Fragment >
    )
