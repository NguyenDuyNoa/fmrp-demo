                ...
                <div className="grid grid-cols-9 gap-5">
                    ...
                    <div className="col-span-7 space-y-3">
                        ...
                        <div className="bg-[#F3F4F6] p-4 rounded grid grid-cols-3 gap-5">
                            <div className="space-y-3">
                                                    ...
                                                    {data?.company_logo && (
                                                        <div className="relative h-full w-full">
                                                            <Image
                                                                ...
                                                                width={120}
                                                                height={120}
                                                                onMouseEnter={_HoverImg.bind(
                                                                    this,
                                                                    true
                                                                )}
                                                                onMouseLeave={_HoverImg.bind(
                                                                    this,
                                                                    false
                                                                )}
                                                                src={
                                                                    typeof data?.company_logo ===
                                                                    "string"
                                                                        ? data?.company_logo
                                                                        : URL.createObjectURL(
                                                                              data?.company_logo
                                ...
                                <p className="text-[#52575E] font-light text-sm">
                                    *Khi thay đổi Ảnh logo này sẽ được áp dụng
                                    cho toàn bộ logo trên Biểu mẫu in ấn của hệ
                                    thống
                                </p>
                            </div>
                            <div className="col-span-2 h-full flex flex-col justify-between">
                                <h3 className="text-[#344054]">
                                    Hồ sơ HĐĐT của đơn vị đã hoàn thiện 10%
                                </h3>
                                ...
                                <p className="text-[#667085] font-[300]">
                                    Hãy hoàn thiện hồ sơ HĐĐT của bạn để phát
                                    hành hóa đơn điện tử nhanh chóng, tránh sai
                                    sót.
                                </p>
                                <div>
                                    <h5 className="text-[#11315B] ">
                                        Thông tin còn thiếu
                                    </h5>
                        ...
                        <div className="flex space-x-5 pt-5">
                            ...
                            <button className="px-8 py-2.5 rounded transition hover:scale-105 bg-slate-200">
                                Hủy
                            </button>
                        </div>
                    </div>
    ...
    return (
        <React.Fragment>
            <p className="font-[400] text-[15px] text-[#0F4F9E] uppercase">
                {props.dataLang?.branch_settings_list
                    ? props.dataLang?.branch_settings_list
                    : "branch_settings_list"}
            </p>
            <div>
                ...
                <Btn_Setting
                    url="/settings/service-information"
                    isActive="/settings/service-information"
                >
                ...
                <Btn_Setting
                    url={`/settings/finance?tab=taxes`}
                    isActive="/settings/finance"
                >
                    {props.dataLang?.list_btn_seting_finance}
                </Btn_Setting>
                <Btn_Setting>{props.dataLang?.list_btn_seting_qt}</Btn_Setting>
                <Btn_Setting>
                    {props.dataLang?.list_btn_seting_order}
                </Btn_Setting>
                <Btn_Setting
                    url={`/settings/category?tab=units`}
                    isActive="/settings/category"
                >
                    {props.dataLang?.list_btn_seting_category}
                </Btn_Setting>
                <Btn_Setting
                    url="/settings/variant"
                    isActive="/settings/variant"
                >
                    {props.dataLang?.list_btn_seting_variant}
                </Btn_Setting>
                <Btn_Setting
                    url="/settings/prefixes"
                    isActive="/settings/prefixes"
                >
