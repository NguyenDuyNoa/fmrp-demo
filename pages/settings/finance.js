                                ...
                                {onFetching ? 
                                    ...
                                    <React.Fragment>
                                        ...
                                        <div className="divide-y divide-slate-200 min:h-[400px] h-[100%] max:h-[600px]"> 
                                            {data.map((e) => 
                                                <div key={e.id.toString()} className={`${(router.query?.tab === "taxes") || (router.query?.tab === "currencies") ? "grid-cols-6" : "grid-cols-9" } grid gap-5 py-2.5 px-2 hover:bg-slate-100/40 `}>
                                                    {((router.query?.tab === "taxes") || (router.query?.tab === "currencies")) && 
                                                        <React.Fragment>
