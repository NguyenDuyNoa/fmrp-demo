      ...
      <div className="pt-5 w-96">
        <form onSubmit={_HandleSubmit.bind(this)} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <div className='pr-3'>
                <button type='button' onClick={_HandleAddNew.bind(this)} title='Thêm' className='w-full h-10 rounded-lg flex flex-col justify-center items-center bg-slate-100 hover:opacity-70 transition'><IconAdd /></button>
              </div>
            </div>       
