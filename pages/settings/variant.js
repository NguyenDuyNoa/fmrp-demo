...
const Index = (props) => {
    ...
    const dataFake = [
        {name: "hihihihihi"},{name: "hehehehehe"},
        {name: "hehehe"},{name: "hihihi"},
        {name: "hehehohohoho"},{name: "hihihi"},
        {name: "hehe"},{name: "hihihi"},
        {name: "hehe"},{name: "hihihi"},
    ]
                                ...
                                <div className="min:h-[500px] h-[100%] max:h-[900px] overflow-auto pb-2 scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-slate-100">
                                    <div className="xl:w-[100%] w-[110%] pr-2">
                                        ...
                                        <div className="divide-y divide-slate-200 min:h-[400px] h-[100%] max:h-[600px]"> 
                                            <div className="grid grid-cols-10 gap-5 py-1.5 px-2 hover:bg-slate-100/40 ">
                                                <h6 className="xl:text-base text-xs px-2 col-span-3 ">hjkhjk</h6>
                                                <div className='col-span-5 px-2 flex flex-wrap'>
                                                    {dataFake.map((e, i) =>
                                                        <h6 key={i} className="mr-2 mb-1 w-fit xl:text-base text-xs px-2 text-[#0F4F9E] font-[300] py-0.5 border border-[#0F4F9E] rounded-lg">{e.name}</h6>
                                                    )}
                                                </div>
                                                <div className="space-x-2 col-span-2 flex justify-center items-start">
                                                    <Popup_ChiNhanh className="xl:text-base text-xs" dataLang={dataLang} />
            ...
            <div className="">
              ...
              <div className='flex space-x-3 items-center'>
                <input
                    ...
                    className="placeholder-[color:#667085] w-full bg-[#ffffff] rounded-lg focus:border-[#92BFF7] text-[#52575E] font-normal  p-2 border border-[#d0d5dd] outline-none"
                />     
                <button title='Thêm' className='transition hover:scale-105 min-w-[40px] h-10 rounded-lg bg-slate-100 flex flex-col justify-center items-center'><IconAdd /></button>
              </div>
            </div>       
