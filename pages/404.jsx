    ...
    return (
        <React.Fragment>
            ...
            <div className="h-[80vh] w-screen flex flex-col justify-center items-center relative space-y-3">
                ...
                <button
                    onClick={_HandleRouterBack.bind(this)}
                    className="flex items-center space-x-2 px-5 py-2.5 bg-gradient-to-l from-[#e2e8f0] via-[#e2e8f0] via-[#cbd5e1] to-[#e2e8f0] rounded btn-animation"
                >
                    <IconBack size={18} />
                    <span>Quay về</span>
                </button>
                ...
                <p>
                    Bạn sẽ được quay về trong <CountUp start={5} end={0} duration={5} /> giây
                </p>
            </div>
        </React.Fragment>
    );
