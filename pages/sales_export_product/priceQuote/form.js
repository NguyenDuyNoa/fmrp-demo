...
const Index = (props) => {
  ...
  const [option, sOption] = useState([{ id: Date.now(), mathang: null, donvitinh: 1, soluong: 1, dongia: 1, chietkhau: 0, dongiasauck: 1, thue: 0, dgsauthue: 1, thanhtien: 1, note: "", price_quote_order_item_id: "" }]);
  ...
  useEffect(() => {
    idBranch === null && sDataCustomer([]) || sIdCustomer(null) || idBranch === null && sDataContactPerson([]) || sIdContactPerson(null)
  }, [])
  ...
  // useEffect(() => {
  //   idTheOrder == null && sIdCustomer(null)
  // }, [idTheOrder]);
  ...
  const options = dataEditItems?.map(e => ({ label: `${e.name} <span style={{display: none}}>${e.code}</span><span style={{display: none}}>${e.product_variation} </span><span style={{display: none}}>${e.text_type} ${e.unit_name} </span>`, value: e.id, e }))
  ...
  const _ServerSending = () => {
    ...
    formData.append("contact_id", idContactPerson?.value)
    ...
    Axios("POST", `${id ? `/api_web/Api_purchase_order/purchase_order/${id}?csrf_protection=true` : "/api_web/Api_quotation/quotation/?csrf_protection=true"}`, {
      data: formData,
  ...
  // console.log("check validate date: ", errDate)
  // console.log("check validate effective date: ", errEffectiveDate)
      ...
      <div className='xl:px-10 px-3 xl:pt-24 pt-[88px] pb-3 space-y-2.5 flex flex-col justify-between'>
        <div className='h-[97%] space-y-3 overflow-hidden'>
          ...
          <div className='flex space-x-3 xl:text-[14.5px] text-[12px]'>
            ...
            <h6>
              {id ? dataLang?.price_quote_edit_order || "price_quote_edit_order" : dataLang?.price_quote_information || "price_quote_information"}
            </h6>
          </div>
          ...
          <div className='flex justify-between items-center'>
            ...
            <div className="flex justify-end items-center">
              ...
              >
                {dataLang?.price_quote_btn_back || "price_quote_btn_back"}
              </button>
            </div>
          </div>
          ...
          <div className=' w-full rounded'>
            <div >
              <h2 className='font-normal bg-[#ECF0F4] p-2'>
                {dataLang?.price_quote_detail_general_information || "price_quote_detail_general_information"}
              </h2>
              <div className="grid grid-cols-12 gap-3 items-center mt-2">
                ...
                <div className='col-span-4'>
                  <label className="text-[#344054] font-normal text-sm mb-1 ">
                    {dataLang?.price_quote_branch || "price_quote_branch"} <span className="text-red-500">*</span>
                  </label>
                  <Select
                    options={dataBranch}
                ...
                <div className='col-span-4'>
                  <label className="text-[#344054] font-normal text-sm mb-1 ">{dataLang?.price_quote_customer} <span className="text-red-500">*</span></label>
                  <Select
                ...
                <div className='col-span-4'>
                  <label className="text-[#344054] font-normal text-sm mb-1 ">{dataLang?.price_quote_contact_person || "price_quote_contact_person"}</label>
                  <Select
                    options={dataPersonContact}
                    onChange={_HandleChangeInput.bind(this, "contactPerson")}
                    value={idContactPerson}
                    placeholder={dataLang?.price_quote_select_contact_person || "price_quote_select_contact_person"}
                    hideSelectedOptions={false}
                    isClearable={true}
        ...
        <div className='grid grid-cols-12'>
          ...
          <div className="text-right mt-5 space-y-4 col-span-3 flex-col justify-between ">
            ...
            <div className='flex justify-between '>
              <div className='font-normal'><h3>{dataLang?.price_quote_discounty || "price_quote_discounty"}</h3></div>
            ...
            <div className='space-x-2'>
              <button
                onClick={() => router.back()}
                className="button text-[#344054] font-normal text-base py-2 px-4 rounded-[5.5px] border border-solid border-[#D0D5DD]">{dataLang?.price_quote_btn_back || "price_quote_btn_back"}</button>
              <button
                onClick={_HandleSubmit.bind(this)}
                type="submit" className="button text-[#FFFFFF]  font-normal text-base py-2 px-4 rounded-[5.5px] bg-[#0F4F9E]">{dataLang?.price_quote_btn_save || "price_quote_btn_save"}</button>
            </div>
          </div>
        </div>
