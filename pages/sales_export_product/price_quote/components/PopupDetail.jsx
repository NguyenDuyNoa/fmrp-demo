                    ...
                    <div>
                        <div className="w-[999px]">
                            <div className="min:h-[170px] h-[72%] max:h-[100px] overflow-auto pb-1 scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-slate-100">
                                ...
                                <div className="grid grid-cols-8  min-h-[170px] px-2">
                                    <div className="col-span-4">
                                        ...
                                        <div className="my-4 font-medium grid grid-cols-2">
                                            ...
                                            <h3 className=" text-[13px]  font-normal">{data?.reference_no}</h3>
                                        </div>
                                        <div className="my-4 font-medium grid grid-cols-2">
                                            <h3 className=" text-[13px] ">
                                            ...
                                            <h3 className=" text-[13px] font-normal">
                                                {(data?.status == "not_confirmed" && (
                                                    ...
                                                    (data?.status == "no_confirmed" && (
                                                        <span className="font-normal text-white  rounded-xl py-1 px-3  bg-[#0F4F9E]">
                                                            Không Duyệt
                                                        </span>
                                                    )) ||
                                                    (data?.status == "confirmed" && (
                                                        <span className="font-normal text-white  rounded-xl py-1 px-3  bg-lime-500">
                                                            Đã Duyệt
                                                        </span>
                                                    )) ||
                                                    (data?.status == "ordered" && (
                                                        <span className="font-normal text-white  rounded-xl py-1 px-3  bg-[#FF8C00]">
                                                            Đã Tạo Đặt Đơn Hàng
                                                        </span>
                                                    ))}
                                            </h3>
                                    ...
                                    <div className="col-span-4 ">
                                        <div className="my-4 font-medium grid grid-cols-2">
                                            ...
                                            <h3 className="text-[13px] font-normal">{data?.client_name}</h3>
                                        </div>
                                        <div className="my-4 font-medium grid grid-cols-2">
                                            <h3 className="text-[13px]">
                                            ...
                                            <h3 className="text-[13px] font-normal">{data?.contact_name}</h3>
                                        </div>
                                        <div className="my-4 font-medium grid grid-cols-2">
                                            <h3 className="text-[13px]">
                                                ...
                                                <div className="divide-y divide-slate-200 min:h-[200px] h-[100%] max:h-[300px]">
                                                    {data?.items?.map((e) => (
                                                        <div
                                                            ...
                                                            key={e.id?.toString()}
                                                        >
                                                            <h6 className="text-[13px]   py-0.5 col-span-1  rounded-md">
                                                                {e?.item?.images != null ? (
                                                                    <ModalImage
                                                                        small={e?.item?.images}
                                                                        large={e?.item?.images}
                                                                        alt="Product Image"
                                                                        className="custom-modal-image object-cover rounded w-[50px] h-[60px] mx-atuo"
                                                                    />
                                                                ) : (
                                                                    <div className="w-[50px] h-[60px] object-cover mx-atuo flex items-center justify-center rounded">
                                                                        <ModalImage
                                                                            small="/no_img.png"
                                                                            large="/no_img.png"
                                ...
                                <h2 className="font-normal p-2 text-[13px]  border-b border-b-[#a9b5c5]  border-t z-10 border-t-[#a9b5c5]">
                                ...
                                <div className="text-right mt-2  grid grid-cols-12 flex-col justify-between sticky bottom-0  z-10 ">
                                    ...
                                    <div className="col-span-2 space-y-2">
                                        <div className="font-normal text-left text-[13px]">
