                                ...
                                <div className="min:h-[200px] 3xl:h-[82%] 2xl:h-[82%] xl:h-[72%] lg:h-[82%] max:h-[400px] overflow-auto pb-2 scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-slate-100">
                                    <div className="pr-2 w-[100%] lg:w-[100%] ">
                                        <div className="grid grid-cols-12 items-center sticky top-0 bg-white p-2 z-10">
                                            ...
                                            <h4 className='3xl:text-[14px] 2xl:text-[12px] xl:text-[10px] text-[9px] text-[#667085] uppercase col-span-1 font-[600] text-left'>{dataLang?.customer || "customer"}</h4>
                                                ...
                                                (
                                                    <div className=" max-w-[352px] mt-24 mx-auto" >
                                                        <div className="text-center">
                                                            ...
                                                            <h1 className="text-[#141522] text-base opacity-90 font-medium">{dataLang?.price_quote_table_item_not_found || "price_quote_table_item_not_found"}</h1>
