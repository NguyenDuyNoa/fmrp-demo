        ...
        <React.Fragment>
            ...
            <div className='3xl:px-10 3xl:pt-16 3xl:pb-3 2xl:pt-[70px] xl:px-10 px-3 pt-16 pb-3 space-y-1 lg:h-screen overflow-hidden flex flex-col justify-between'>
                <div className='space-y-2 overflow-hidden px-2 py-4'>
                    ...
                    <h2 className='3xl:text-3xl 2xl:text-2xl xl:text-2xl lg:text-2xl text-xl font-medium'>Quy Trình Bán Hàng</h2>
                </div>
                        ...
                        <div className='h-[100%] w-full space-y-6'>
                            <div className='h-full w-full 3xl:ml-16 2xl:ml-0 xl:ml-5 xl:pb-16 lg:pb-32 flex flex-row justify-start items-center gap-2'>
                                <div className='3xl:h-24 3xl:w-24 2xl:h-20 2xl:w-20 xl:h-16 xl:w-16 lg:h-16 lg:w-16 rounded-full flex flex-col justify-center items-center bg-[#3276FA] text-white'>
                                    <h5 className='3xl:text-xl 2xl:text-[15px] xl:text-[14px] lg:text-[14px] text-center'>Bắt đầu</h5>
                                </div>
                                ...
                                <div className='3xl:h-[96px] 3xl:w-[180px] 2xl:h-[80px] 2xl:w-[170px] xl:h-[64px] xl:w-[130px] lg:h-[60px] lg:w-[120px] flex space-x-3 border-none bg-[#E2F0FE] rounded-md  items-center justify-center relative'>
                                    <h5 className='3xl:max-w-[180px] 2xl:max-w-[170px] xl:max-w-[80px] lg:max-w-[100px] text-center'>Tạo đơn hàng</h5>
                                    ...
                                    <div className="absolute 3xl:-top-[160%] 2xl:-top-[155%] xl:-top-[165%] lg:-top-[175%]">
                                        ...
                                        />
                                        <span
                                            className="3xl:translate-x-[-60%] 3xl:translate-y-[-60%] 2xl:translate-x-[-56%] 2xl:translate-y-[-60%] xl:translate-x-[-60%] xl:translate-y-[-60%] lg:translate-x-[-120%] lg:translate-y-[-50%] 3xl:top-[30%] 2xl:top-[30%] xl:top-[32%] lg:top-[30%] 2xl:left-[52%] lg:left-[68%] 3xl:text-[10px] 2xl:text-[8px] xl:text-[7px] lg:text-[7px] 2xl:p-3 xl:p-2 lg:p-2 font-[600] absolute select-none pointer-events-none "
                                        >
                                ...
                                <div className='3xl:h-[96px] 3xl:w-[180px] 2xl:h-[80px] 2xl:w-[170px] xl:h-[64px] xl:w-[130px] lg:h-[60px] lg:w-[130px] flex space-x-3 border-none bg-[#E2F0FE] rounded-md  items-center justify-center relative'>
                                    <h5 className='3xl:max-w-[180px] 2xl:max-w-[170px] xl:max-w-[80px] lg:max-w-[100px] text-center'>Xuất kho giao hàng</h5>
                                ...
                                <div className='3xl:h-[96px] 3xl:w-[180px] 2xl:h-[80px] 2xl:w-[170px] xl:h-[64px] xl:w-[130px] lg:h-[60px] lg:w-[120px] flex space-x-3 border-none bg-[#E2F0FE] rounded-md  items-center justify-center relative'>
                                    ...
                                    <div className='flex border rounded-md 3xl:h-[96px] 3xl:w-[180px] 2xl:h-[78px] 2xl:w-[170px] xl:h-[64px] xl:w-[130px] lg:h-[60px] lg:w-[120px] 3xl:top-[160%] 3xl:right-[2%] 2xl:top-[160%] 2xl:left-[-6%] xl:top-[170%] xl:left-[-10%] lg:top-[175%] lg:-right-[2%]  items-center justify-center absolute  bg-[#FDE7AE]'>
                                        <h5 className='3xl:max-w-[180px] 2xl:max-w-[170px] xl:max-w-[80px] lg:max-w-[90px] text-center'>Trả lại hàng bán</h5>
                                ...
                                <div className='3xl:h-24 3xl:w-24 2xl:h-20 2xl:w-20 xl:h-16 xl:w-16 lg:h-16 lg:w-16 rounded-full flex flex-col justify-center items-center bg-[#3276FA] text-white'>
                                    <h5 className='3xl:text-xl 2xl:text-[15px] xl:text-[14px] lg:text-[14px] text-center'>Kết thúc</h5>
                                </div>
                            </div>
                        </div>
                    </div>
