                  ...
                  <div className="bg-white px-16 pt-20 pb-12 rounded-lg space-y-10 w-[600px]">
                    ...
                    <div className="space-y-3">
                      ...
                      <input
                        type="text"
                        placeholder={
                          dataLang?.auth_user_name || "auth_user_name"
                        }
                        value={name}
                        id="username"
                      ...
                      <div className="relative flex flex-col justify-center">
                        <input
                          ...
                          placeholder={
                            dataLang?.auth_password || "auth_password"
                          }
                          value={password}
                          id="userpwd"
                        ...
                        {listPosition.map((e) => (
                          ...
                          >
                            ...
                            <label
                              ...
                              className="text-[#52575E] 2xl:text-base text-sm"
                            >
                              {e?.title}
                            </label>
                          </div>
                ...
                {stepRegister == 0 ? (
                  <>
                    <button
                      ...
                      className="w-full py-4 text-center rounded bg bg-[#0F4F9E] text-white 2xl:mt-8 mt-5"
                    >
                      Tiếp theo
                    </button>
                  ...
                  <>
                    <button className="w-full 2xl:py-4 py-3 text-center rounded bg bg-[#0F4F9E] text-white 2xl:mt-8 mt-5">
                      Đăng ký
                    </button>
                    <button
