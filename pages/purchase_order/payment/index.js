    ...
    <div>
      <Popup
        trigger={
          <button
            type="button"
            className={`flex space-x-1 items-center ` + props.className}
          >
    ...
    await Axios(
      ...
      (err, response) => {
        if (!err) {
          ...
          sTypeOfDocument(
            db?.type_vouchers
              ? { label: dataLang[db?.type_vouchers], value: db?.type_vouchers }
              : null
          );
          sListTypeOfDocument(
            db?.type_vouchers
          ...
          sOption(
            db?.detail?.map((e) => ({
              id: e?.id,
              chiphi: { label: e?.costs_name, value: e?.id_costs },
    ...
    Axios(
      ...
      (err, response) => {
        if (!err) {
          ...
          sDataTypeofDoc(
            db?.map((e) => ({ label: dataLang[e?.name], value: e?.id }))
          );
        }
      }
    );
    ...
    Axios(
      ...
      (err, response) => {
        if (!err) {
          var db = response.data;
          sDataListTypeofDoc(
            db?.map((e) => ({ label: e?.code, value: e?.id, money: e?.money }))
          );
        }
      }
    );
  ...
  const _HandleChangeInputOption = (id, type, value) => {
    ...
    if (type === "chiphi") {
      ...
      if (totalSotien > parseFloat(price)) {
        ...
        Toast.fire({
          title: `${
            props?.dataLang?.payment_err_alerExeeds || "payment_err_alerExeeds"
          }`,
          icon: "error",
          confirmButtonColor: "#296dc1",
          cancelButtonColor: "#d33",
              ...
              <div className="grid grid-cols-12 space-x-1 items-center">
                ...
                <div className="col-span-6">
                  ...
                  <input
                    ...
                    placeholder={
                      props.dataLang?.payment_systemDefaul ||
                ...
                <div className="col-span-6">
                  ...
                  <Select
                    ...
                    className={`${
                      errMethod ? "border-red-500" : "border-transparent"
                ...
                <div className="col-span-6  ">
                  <label className="text-[#344054] font-normal 2xl:text-[12px] xl:text-[13px] text-[12px] ">
                    {props.dataLang?.payment_typeOfDocument ||
                      "payment_typeOfDocument"}
                  </label>
                  <Select
                    closeMenuOnSelect={true}
                  ...
                  {errListTypeDoc &&
                    ...
                    listTypeOfDocument?.length == 0 && (
                      <label className="2xl:text-[12px] xl:text-[13px] text-[12px] text-red-500">
                        {props.dataLang?.payment_errlistOfDoc ||
                ...
                <div className="col-span-6">
                  <label className="text-[#344054] font-normal 2xl:text-[12px] xl:text-[13px] text-[12px] ">
                    {props.dataLang?.payment_amountOfMoney ||
                      "payment_amountOfMoney"}{" "}
                    <span className="text-red-500">*</span>
                  </label>
                  <NumericFormat
                    ...
                    placeholder={
                      ((object == null || listObject == null) &&
                        (props.dataLang?.payment_errObList ||
                          "payment_errObList")) ||
                      (object != null &&
                        props.dataLang?.payment_amountOfMoney) ||
                      "payment_amountOfMoney"
                      ...
                      >
                        <div className="col-span-6  my-auto ">
                          <Select
                            closeMenuOnSelect={true}
                            placeholder={
                              props.dataLang?.payment_expense ||
                              "payment_expense"
                            }
                ...
                <div className="min-h-[130px] px-2 bg-gray-50 ">
                  <div className="grid grid-cols-2 space-x-4">
                    ...
                    <div className="col-span-1 ">
                      ...
                      <div className="my-4 font-semibold grid grid-cols-2">
                        <h3 className=" text-[13px] ">
                          {props.dataLang?.payment_TT_method ||
                            "payment_TT_method"}
                        </h3>
                        <h3 className=" text-[13px]  font-medium">
