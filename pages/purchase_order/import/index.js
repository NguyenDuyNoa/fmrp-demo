          ...
          <div className="col-span-7 h-[100%] flex flex-col justify-between overflow-hidden">
                ...
                <div className="min:h-[200px] h-[82%] max:h-[500px]  overflow-auto pb-2 scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-slate-100">
                  <div className="pr-2 w-[100%] lx:w-[120%] ">
                    <div className="grid grid-cols-12 items-center sticky top-0 bg-white p-2 z-10 shadow">
                                <h4 className='3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px] px-2 text-[#667085] uppercase col-span-1 font-[300] text-center'>{dataLang?.import_day_vouchers || "import_day_vouchers"}</h4>
                                <h4 className='3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px] px-2 text-[#667085] uppercase col-span-1 font-[300] text-center'>{dataLang?.import_code_vouchers || "import_code_vouchers"}</h4>
                                <h4 className='3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px] px-2 text-[#667085] uppercase col-span-1 font-[300] text-center'>{dataLang?.import_supplier || "import_supplier"}</h4>
                                <h4 className='3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px] px-2 text-[#667085] uppercase col-span-1 font-[300] text-center'>{dataLang?.import_the_order || "import_the_order"}</h4>
                                <h4 className='3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px] px-2 text-[#667085] uppercase col-span-1 font-[300] text-center'>{dataLang?.import_total_amount || "import_total_amount"}</h4>
                                <h4 className='3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px] px-2 text-[#667085] uppercase col-span-1 font-[300] text-center'>{dataLang?.import_tax_money || "import_tax_money"}</h4>
                                <h4 className='3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px] px-2 text-[#667085] uppercase col-span-1 font-[300] text-center'>{dataLang?.import_into_money || "import_into_money"}</h4>
                                <h4 className='3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px] px-2 text-[#667085] uppercase col-span-2 font-[300] text-center'>{dataLang?.import_payment_status || "import_payment_status"}</h4>
                                <h4 className='3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px] px-2 text-[#667085] uppercase col-span-1 font-[300] text-center'>{dataLang?.import_brow_storekeepers || "import_brow_storekeepers"}</h4>
                                <h4 className='3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px] px-2 text-[#667085] uppercase col-span-1 font-[300] text-center'>{dataLang?.import_branch || "import_branch"}</h4>
                                <h4 className='3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px] px-2 text-[#667085] uppercase col-span-1 font-[300] text-center'>{dataLang?.import_action || "import_action"}</h4>
                    </div>
                    {onFetching ?
                      ...
                      (<>
                          ...
                          {(data?.map((e) => 
                                ...
                                <div className='grid grid-cols-12 items-center py-1.5 px-2 hover:bg-slate-100/40 ' key={e.id.toString()}>
                                <h6 className='3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px] px-2 col-span-1 text-center'>{e?.date != null ? moment(e?.date).format("DD/MM/YYYY") : ""}</h6>
                                <h6 className='3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px] px-2 col-span-1 text-center text-[#0F4F9E] hover:font-normal cursor-pointer'><Popup_chitiet dataLang={dataLang} className="text-left" name={e?.code} id={e?.id}/></h6>
                                {/* <h6 className='3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px] px-2 col-span-1 text-center text-[#0F4F9E] hover:font-normal cursor-pointer'>{e?.code}</h6> */}
                                <h6 className='3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px] px-2 col-span-1 text-left'>{e.supplier_name}</h6>
                                <h6 className='px-2 py-2.5 3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px] col-span-1 flex items-center justify-center text-center'>{<span className='font-normal text-lime-500  rounded-xl py-1 px-3  bg-lime-200 min-w-[100px]'>{e?.purchase_order_code}</span>}</h6>
                                {/* <h6 className='3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px] px-2 col-span-1 text-left flex gap-2 flex-wrap'>{e?.purchases?.map(e => {return (<span>{e.code}</span>)})}</h6> */}
                                <h6 className='3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px] px-2 col-span-1 text-right'>{formatNumber(e.total_price)}</h6>
                                <h6 className='3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px] px-2 col-span-1 text-right'>{formatNumber(e.total_tax_price)}</h6>
                                <h6 className='3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px] px-2 col-span-1 text-right'>{formatNumber(e.total_amount)}</h6>
                                ...
                                <h6 className='px-2 py-2.5 3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px] col-span-2 '>
                                    <div className='flex flex-wrap  gap-2 items-center justify-center'>
                                      {
                                    e?.status === "0" && <span className=' font-normal text-sky-500  rounded-xl py-1 px-2 min-w-[135px]  bg-sky-200 text-center 3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px]'>{"Chưa chi"}</span>||
                                    e?.status === "1" && <span className=' font-normal text-orange-500 rounded-xl py-1 px-2 min-w-[135px]  bg-orange-200 text-center 3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px]'>{"chi 1 phần"} {`(${e?.count})`}</span>||
                                    e?.status === "2" && <span className='flex items-center gap-1 font-normal text-lime-500  rounded-xl py-1 px-2 min-w-[135px]  bg-lime-200 text-center 3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px]'><TickCircle className='bg-lime-500 rounded-full' color='white' size={15}/>{"Đã chi đủ"} {`(${e?.order_status?.count})`}</span>
                                      }
                                    </div>
                                  </h6>
                                ...
                                <h6 className=' 3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px] col-span-1 cursor-pointer'>
                                  <div className={`${e?.warehouseman_id == "0" ? "bg-[#eff6ff] " : "bg-lime-100"} rounded-md cursor-pointer` }>
                                    <div className='flex items-center justify-center'>
                                         ...
                                         <label htmlFor={e.id} className={`${e?.warehouseman_id == "0" ? "text-[#6366f1]" : "text-lime-500"}  3xl:text-[13px] 2xl:text-[10px] xl:text-[10px] text-[8px] font-medium cursor-pointer`}>{e?.warehouseman_id == "0" ? "Chưa duyệt kho" : "Đã duyệt kho"}</label>
                                    </div>
                                  </div>
                                </h6>
                                <h6 className=' px-2 col-span-1'><span className="mr-2 mb-1 w-fit 3xl:text-[13px] 2xl:text-[10px] xl:text-[10px] text-[8px] px-2 text-[#0F4F9E] font-[300] py-0.5 border border-[#0F4F9E] rounded-[5.5px]">{e?.branch_name}</span></h6> 
                                <div className='col-span-1 flex justify-center'>
                                    <BtnTacVu onRefresh={_ServerFetching.bind(this)} onRefreshGroup={_ServerFetching_group.bind(this)} dataLang={dataLang} warehouseman_id={e?.warehouseman_id} id={e?.id}className="bg-slate-100 xl:px-4 px-3 xl:py-1.5 py-1 rounded 3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px]" />
                                </div>
                                </div>
            ...
            <div className='grid grid-cols-12 bg-gray-100 items-center'>
                    <div className='col-span-4 p-2 text-center'>
                        <h3 className='uppercase font-normal 3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px]'>{dataLang?.import_total || "import_total"}</h3>
                    </div>  
                    <div className='col-span-1 text-right justify-end p-2 flex gap-2 flex-wrap'>
                        <h3 className='font-normal 3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px]'>{formatNumber(total?.total_price)}</h3>
                    </div>  
                    <div className='col-span-1 text-right justify-end p-2 flex gap-2 flex-wrap '>
                        <h3 className='font-normal 3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px]'>{formatNumber(total?.total_tax_price)}</h3>
                    </div>  
                    <div className='col-span-1 text-right justify-end p-2 flex gap-2 flex-wrap'>
                        <h3 className='font-normal 3xl:text-[13px] 2xl:text-[12px] xl:text-[11.5px] text-[9px]'>{formatNumber(total?.total_amount)}</h3>
                    </div>  
            </div>
            {data?.length != 0 &&
