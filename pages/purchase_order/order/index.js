                ...
                <div className='3xl:h-[65%] 2xl:h-[60%] xl:h-[55%] h-[57%] space-y-2'>
                    ...
                    <div className='flex justify-between items-center'>
                        ...
                        <div className='flex space-x-3 items-center'>
                            <Link href="/purchase_order/order/form" className='xl:text-sm text-xs xl:px-5 px-3 xl:py-2.5 py-1.5 bg-gradient-to-l from-[#0F4F9E] via-[#0F4F9E] via-[#296dc1] to-[#0F4F9E] text-white rounded btn-animation hover:scale-105'>Tạo mới</Link>
