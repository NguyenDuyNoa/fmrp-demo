      ...
      (err, response) => {
        if (!err) {
          ...
          dispatch({
            ...
            payload: rResult.map((e) => ({ label: e.unit, value: e.id })),
          });
        }
      }
    );
          ...
          <div className="min:h-[500px] 2xl:h-[90%] xl:h-[69%] h-[72%] max:h-[800px] overflow-auto pb-2 scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-slate-100">
            <div className="pr-2">
              <div className="flex items-center sticky top-0 bg-white p-2 z-10 shadow-[-20px_-9px_20px_0px_#0000003d]">
                <h4 className="xl:w-[10%] w-[6%] 2xl:text-[14px] xl:text-[13px] text-[12px] px-2 text-[#667085] uppercase text-center font-[300]">
                  {dataLang?.image || "image"}
                </h4>
                <h4 className="2xl:text-[14px] xl:text-[13px] text-[12px] px-2 text-[#667085] uppercase xl:w-[11%] w-[12%] font-[300]">
                  {dataLang?.category_material_group_name ||
                    "category_material_group_name"}
                </h4>
                <h4 className="2xl:text-[14px] xl:text-[13px] text-[12px] px-2 text-[#667085] uppercase xl:w-[13%] w-[14%] truncate font-[300]">
                ...
                <h4 className="2xl:text-[14px] xl:text-[13px] text-[12px] px-2 text-[#667085] uppercase w-[7%] font-[300] text-center">
                  {dataLang?.unit || "unit"}
                </h4>
                <h4 className="2xl:text-[14px] xl:text-[13px] text-[12px] px-2 text-[#667085] uppercase xl:w-[6%] w-[8%] font-[300] text-center">
                  {dataLang?.stock || "stock"}
                </h4>
                <h4 className="2xl:text-[14px] xl:text-[13px] text-[12px] px-2 text-[#667085] uppercase w-[11%] font-[300]">
                  {dataLang?.note || "note"}
                </h4>
                <h4 className="2xl:text-[14px] xl:text-[13px] text-[12px] px-2 text-[#667085] uppercase xl:w-[6%] w-[7%] font-[300] text-center truncate">
                  {dataLang?.category_material_list_variant ||
                    "category_material_list_variant"}
                </h4>
                <h4 className="2xl:text-[14px] xl:text-[13px] text-[12px] px-2 text-[#667085] uppercase w-[15%] font-[300] truncate">
                  {dataLang?.client_list_brand || "client_list_brand"}
                </h4>
                <h4 className="2xl:text-[14px] xl:text-[13px] text-[12px] px-2 text-[#667085] uppercase xl:w-[8%] w-[6%] font-[300] text-center truncate">
                  ...
                  <div className="divide-y divide-slate-200">
                    {data.map((e) => (
                      ...
                      >
                        ...
                        <h6 className="px-2 py-2.5 xl:text-base text-xs xl:w-[11%] w-[12%]">
                          {e?.category_name}
                        </h6>
                        ...
                        <h6 className="px-2 py-2.5 xl:text-base text-xs xl:w-[13%] w-[14%]">
                          {e?.name}
                        </h6>
                        <h6 className="px-2 py-2.5 xl:text-base text-xs w-[7%] text-center">
                          {e?.unit}
                        </h6>
                        <h6 className="px-2 py-2.5 xl:text-base text-xs xl:w-[6%] w-[8%] text-center">
                          {e?.stock_quantity}
                        </h6>
                        <h6 className="px-2 py-2.5 xl:text-base text-xs w-[11%]">
                          {e?.note}
                        </h6>
                        <h6 className="px-2 py-2.5 xl:text-base text-xs xl:w-[6%] w-[7%] text-center">
                ...
                <div className="grid grid-cols-2 gap-5">
                  <div className="2xl:space-y-3 space-y-2">
                    ...
                    <div className="2xl:space-y-1">
                      ...
                      {errName && (
                        <label className="text-sm text-red-500">
                          {props.dataLang?.category_material_list_err_name}
                        </label>
                      )}
                    </div>
                    <div className="2xl:space-y-1">
                  ...
                  {Object.keys(dataTotalVariant).length !== 0 && (
                    <div className="space-y-1">
                      ...
                      >
                        ...
                        {dataTotalVariant[0]?.variation_option_2?.length >
                          0 && (
                          <h4 className="text-[15px] font-[300] text-slate-400">
              ...
              <div className="grid grid-cols-2 gap-5">
                <div className="space-y-3 bg-slate-100/40 p-2 rounded-md">
                  ...
                  <div className="flex justify-between">
                    ...
                    <h6 className="w-[55%] text-right">
                      {Number(list?.import_price).toLocaleString()}
                    </h6>
                  </div>
                  <div className="flex justify-between">
                    <h5 className="text-slate-400 text-sm w-[40%]">
                    ...
                    <h6 className="w-[55%] text-right">
                      {Number(list?.minimum_quantity).toLocaleString()}
                    </h6>
                  </div>
                  {props.dataMaterialExpiry?.is_enable === "1" ? (
                    <div className="flex justify-between">
