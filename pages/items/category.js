                    ...
                    <div className='min:h-[500px] h-[100%] max:h-[900px] overflow-auto pb-2 scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-slate-100'>
                        <div className='xl:w-[100%] w-[110%] pr-2'>
                            <div className='flex items-center sticky top-0 bg-white p-2 z-10'>
                                ...
                                <h4 className='w-[5%]'/>
                                <h4 className='xl:text-[14px] text-[12px] px-2 text-[#667085] uppercase w-[35%] font-[300]'>mã danh mục</h4>
                                ...
                                <h4 className='xl:text-[14px] text-[12px] px-2 text-[#667085] uppercase w-[8%] font-[300] text-center'>tác vụ</h4>
                            </div>
                            <div className='divide-y divide-slate-200 overflow-auto min:h-[400px] h-[100%] max:h-[600px]'>
                                {dataFake.map((e,i) => 
                                    <div>
                                        <div key={i} className='flex items-center py-1.5 px-2 hover:bg-slate-100/40 '>
                                            <div className='w-[2%]'>
                                                <input type='checkbox' className='scale-125' />
                                            </div>
                                            ...
                                            <h6 className='xl:text-base text-xs px-2 w-[35%]'>{e.id}</h6>
