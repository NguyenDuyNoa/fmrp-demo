                ...
                smoothScrolling={true}>
                  ...
                  <div className="flex gap-5 rounded-md ">
                    ...
                    <div className='w-[50%] bg-slate-100/40'>
                      ...
                      <div className='mb-4 flex justify-between items-center p-2'><span className='text-slate-400 text-sm'>{props.dataLang?.client_popup_date}:</span> <span className='font-normal capitalize'>{data?.date_incorporation != null ? moment(data?.date_incorporation).format("DD/MM/YYYY"): ''}</span></div>
