...
const Index = (props) => {
    ...
    const handleDelete = async () => {
        Axios("DELETE", `/api_web/api_staff/department/${isId}?csrf_protection=true`, {}, (err, response) => {
            if (!err) {
    ...
    //             const id = event;
    //             Axios("DELETE", `/api_web/api_staff/department/${id}?csrf_protection=true`, {}, (err, response) => {
    //                 if (!err) {
