  ...
  const handleDelete = (event) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        const id = event;
        Axios("DELETE", `/api_web/api_staff/department/${id}?csrf_protection=true`, {
        }, (err, response) => {
          if(!err){
        ...
        <div className="grid grid-cols gap-5 h-[99%] overflow-hidden">
          <div className="col-span-7 h-[100%] flex flex-col justify-between overflow-hidden">
            <div className="space-y-3 h-[96%] overflow-hidden">
                ...
                <h2 className="text-2xl text-[#52575E]">{dataLang?.personnels_deparrtments_title}</h2>
                  <div className="flex justify-end items-center">
                    <Popup_phongban listBr={listBr} onRefresh={_ServerFetching.bind(this)} dataLang={dataLang} className="xl:text-sm text-xs xl:px-5 px-3 xl:py-2.5 py-1.5 bg-gradient-to-l from-[#0F4F9E] via-[#0F4F9E] via-[#296dc1] to-[#0F4F9E] text-white rounded btn-animation hover:scale-105" />
                  </div>
                </div>
              ...
              <div className="space-y-2 2xl:h-[95%] h-[92%] overflow-hidden">
                ...
                <div className="xl:w-[100%] w-[110%] pr-2 ">
                    <div className="flex items-center sticky top-0 bg-white p-2 z-10">
                      <h4 className="xl:text-[14px] text-[12px] px-2 text-[#667085] uppercase w-[30%] font-[300] text-left">{dataLang?.personnels_deparrtments_name}</h4>
                      <h4 className="xl:text-[14px] text-[12px] px-2 text-[#667085] uppercase w-[25%] font-[300] text-left">{dataLang?.personnels_deparrtments_email}</h4>
                      <h4 className="xl:text-[14px] text-[12px] px-2 text-[#667085] uppercase w-[25%] font-[300] text-left">{dataLang?.client_list_brand}</h4>
                        ...
                        <div className=" max-w-[352px] mt-24 mx-auto" >
                          <div className="text-center">
                            ...
                            <div className="flex items-center justify-around mt-6 ">
                                <Popup_phongban onRefresh={_ServerFetching.bind(this)} dataLang={dataLang} className="xl:text-sm text-xs xl:px-5 px-3 xl:py-2.5 py-1.5 bg-gradient-to-l from-[#0F4F9E] via-[#0F4F9E] via-[#296dc1] to-[#0F4F9E] text-white rounded btn-animation hover:scale-105" />    
                            </div>
                          </div>
                        </div>
                      )}    
      ...
      <div className="w-96 mt-4">
        <form onSubmit={_HandleSubmit.bind(this)}>
          ...
          <div className="flex flex-wrap justify-between">
                    <label className="text-[#344054] font-normal text-sm mb-1 ">{props.dataLang?.personnels_deparrtments_name} <span className="text-red-500">*</span></label>
                    <input
                      value={name}                
