                    ...
                    <div className="w-[50%] bg-slate-100/40 rounded-md">
                      ...
                      <h6>
                        <div className="mb-4 flex justify-between  p-2 items-center flex-wrap mt-1">
                          ...
                          <span className="flex justify-start gap-1 items-center flex-wrap mt-2">
                            {data?.branch?.map((e) => {
                              return (
                                <span
                                  key={e.id}
                      ...
                      <div className="divide-y divide-slate-200 min:h-[400px] h-[100%] max:h-[500px]">
                        <div className="">
                          ...
                          <div className="mb-2 flex flex-wrap p-2 items-center">
                            ...
                            <span className="flex  gap-1 items-center flex-wrap mt-2">
                              {data?.manage?.map((e) => {
                                return (
                                  <span
                                    key={e.id}
                                    className="last:ml-0 font-normal capitalize  w-fit xl:text-base text-xs   gap-2 mb-2"
                                  >
                                    {" "}
                                    {e.full_name}
                                  </span>
                          ...
                          <div className="mb-4 flex flex-wrap p-2 ">
                            <span className="text-slate-400 text-sm w-[15%] ">
                              {props.dataLang?.personnels_staff_table_depart}:
                            </span>{" "}
