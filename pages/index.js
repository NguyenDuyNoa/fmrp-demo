      ...
      <div className="px-10 py-8 space-y-5 pt-24 overflow-x-auto text">
        ...
        <div className="flex space-x-5 justify-between">
          ...
          <button
            ...
            type="button"
            className="rounded-md px-3.5 py-2 m-1 hover:scale-105 transition-all duration-500 overflow-hidden relative group cursor-pointer border-2 font-medium border-indigo-600 text-indigo-600 text-white"
          >
