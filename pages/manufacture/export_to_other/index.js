...
const Index = (props) => {
    ...
    const _HandleSeachApi = debounce((inputValue) => {
        Axios("POST", `/api_web/Api_export_other/exportOtherCombobox/?csrf_protection=true`,
            {
                data: {
                    term: inputValue,
                },
    ...
    const _ServerSending = () => {
        ...
        Axios("POST", `/api_web/Api_export_other/confirmWarehouse?csrf_protection=true `,
            {
                data: data,
        ...
        <React.Fragment>
            ...
            <Container>
                {isState.data_export.length > 0 && (
                    <Popup_status type="recall" className="hidden" data_export={isState.data_export} dataLang={dataLang} />
                )}
                {trangthaiExprired ? (
                    <EmptyExprired />
                ) : (
                                                ...
                                                {isState.data?.map((e) => (
                                                    <RowTable gridCols={11} key={e.id.toString()} >
                                                        ...
                                                        <RowItemTable colSpan={1} className="flex items-center justify-center">
                                                            {
                                                                e?.object == "client" && <TagColorSky name={dataLang[e?.object]} /> ||
                                                                e?.object == "supplier" && <TagColorOrange name={dataLang[e?.object]} /> ||
                                                                e?.object == "other" && <TagColorRed name={dataLang[e?.object]} /> ||
                                                                e?.object == "staff" && <TagColorMore backgroundColor={'#99f6e4'} color={'#0f766e'} name={dataLang[e?.object]} />
                                                            }
                                                        </RowItemTable>
                                                        <RowItemTable colSpan={1} textAlign={'right'} className=""></RowItemTable>
                                                        <LinkWarehouse
                                                            colSpan={1}
                                                        ...
                                                        <RowItemTable colSpan={1}>
                                                            <CustomAvatar fullName={e?.staff_create?.full_name} profileImage={e?.staff_create?.profile_image} data={e} />
                                                        </RowItemTable>
                                                        <RowItemTable colSpan={1}>
                                                            <ButtonWarehouse
