...
const Index = (props) => {
    ...
    const [idImportWarehouse, sIdExportWarehouse] = useState(null);
        ...
        Axios(
            ...
            `/api_web/Api_product_receipt/productReceipt/?csrf_protection=true`,
            {
                params: {
                    ...
                    "filter[warehouse_id]": idImportWarehouse != null ? idImportWarehouse?.value : null,
                },
            },
            (err, response) => {
                if (!err) {
    ...
    useEffect(() => {
        (router.query.tab && sOnFetching(true)) ||
            ...
            (idImportWarehouse != null && sOnFetching(true));
    }, [
        limit,
        router.query?.page,
        router.query?.tab,
    ...
    const onchang_filter = (type, value) => {
        if (type == "branch") {
            ...
            sIdCode(value);
        } else if (type == "idImportWarehouse") {
                        ...
                        <div className="space-y-0.5 h-[96%] overflow-hidden">
                            <div className="flex justify-between mt-1 mr-2">
                                ...
                                <div className="flex justify-end items-center">
                                    <Link
                                        href="/manufacture/productsWarehouse/form"
                                            ...
                                            <div className="grid grid-cols-5 items-center">
                                                ...
                                                <div className="ml-1 col-span-1">
                                                    <Select
                                                        ...
                                                        onChange={onchang_filter.bind(this, "idImportWarehouse")}
