            ...
            <div className="pr-4 pl-3">
                <div className="border-b border-gray-300 flex justify-between py-4">
                    <div className="flex items-center gap-2">
                        <FaAngleDoubleRight className="text-gray-600 text-sm cursor-pointer" onClick={() => {
                            if (width == 900) {
                        ...
                        <h1 className="text-[#0F4F9E] font-medium">{dataLang?.productions_orders_details || 'productions_orders_details'}</h1>
                    </div>
                    <button
                        onClick={() => {
                            queryState({ openModal: !isState.openModal, dataModal: {} });
                ...
                <div className="border-b mt-4">
                    <ContainerFilterTab>
                        {listTab.map((e) => (
                            ...
                            >
                                <h3 className={`relative py-[10px] px-2  font-normal ${isStateModal.isTab == e.id ? "text-[#0F4F9E]" : "text-[#667085]"} text-base group-hover:text-[#0F4F9E] transition-all duration-200 ease-linear`}
                                >
                                    {e.name}
