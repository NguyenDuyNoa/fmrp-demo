...
const TabInFormation = memo(({ isStateModal, width, dataLang, listTab }) => {
        ...
        <div>
            ...
            <div className="flex gap-2 w-full overflow-auto ">
                <div
                    className={`${
                        width > 900
                            ? "3xl:w-[15%] 2xl:w-[23%] xl:w-[25%] lg:w-[25%]"
                            : "3xl:w-[30%] 2xl:w-[30%] xl:w-[35%] lg:w-[30%]"
                    }  flex items-start py-2 px-4 gap-2 bg-gray-50 border rounded-md`}
                >
                    <ModalImage
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <h1 className={`text-[#9295A4] font-normal text-sm`}>
                            ...
                            <span
                                className={`py-[1px] px-1 rounded border h-fit w-fit font-[300] break-words leading-relaxed text-xs
                                             ${
                                                 (isInfomation.dataInformation.type === "products" &&
                                                     "text-lime-500 border-lime-500") ||
                                                 (isInfomation.dataInformation.type === 1 &&
                                                     "text-orange-500 border-orange-500") ||
                                                 (isInfomation.dataInformation.type === 2 &&
                        ...
                        <h1 className="text-[#9295A4] font-normal text-sm">
                            Số lượng:{" "}
                            <span className="text-sm font-semibold text-black">
                                {isInfomation.dataInformation.quantity > 0
                                    ? formatNumber(isInfomation.dataInformation.quantity)
                                    : "-"}
                            </span>
                        </h1>
                        <h1 className="text-[#9295A4] font-normal text-sm">
                            Đã hoàn thành:{" "}
                            <span className="text-sm font-semibold text-black">
                                {isInfomation.dataInformation.quantitySussces > 0
                                    ? formatNumber(isInfomation.dataInformation.quantitySussces)
                                    : "-"}
                            </span>
                        </h1>
                    </div>
                ...
                <div
                    className={`flex flex-nowrap gap-2 justify-start  ${
                        width > 900
                            ? "3xl:h-[calc(100vh_-_343px)] 2xl:h-[calc(100vh_-_343px)] xxl:h-[calc(100vh_-_345px)] 3xl:w-[85%] 2xl:w-[77%] xl:w-[75%] lg:w-[75%]"
                            : "3xl:h-[calc(100vh_-_500px)] h-[calc(100vh_-_460px)] 3xl:w-[70%] 2xl:w-[70%] xl:w-[65%] lg:w-[70%]"
                    }   
                            ...
                            <div className="min-w-fit max-w-fit w-fit">
                                <div className="bg-white sticky top-0 z-10 ">
                                    <div
                                        ...
                                        className={` text-xs flex items-start py-2 px-4 gap-2
                                            ${
                                                e.show ? "bg-blue-500 text-white" : "bg-gray-50"
                                            } hover:bg-blue-500 hover:text-white transition-all duration-150 ease-linear border rounded-md w-fit cursor-pointer`}
                                    >
                                            ...
                                            {e.processBar.map((j, jIndex) => {
                                                return (
                                                    <li
                                                        key={jIndex}
                                                        className={`${
                                                            jIndex == e.processBar?.length - 1
                                                                ? "relative flex-1"
                                                                : `relative flex-1 after:content-['']  after:w-0.5 after:h-full  after:inline-block after:absolute after:top-0 after:left-[5px] ${
                                                                      j.active
                                                                          ? "after:bg-[#00C170]"
                                                                          : "after:bg-gray-500"
                                                                  } `
                                                    ...
                                                    >
                                                        <div className="flex font-medium w-full">
                                                            <span
                                                                className={`w-3 h-3 ${
                                                                    j.active ? "bg-[#00C170]" : "bg-gray-500"
                                                                } border-2 border-transparent rounded-full mr-3 text-sm text-white`}
                                                            ></span>
                                                            <div className="block">
                                                                <h4
                                                                    className={`3xl:text-base xxl:text-sm text-xs ${
                                                                        j.active ? "text-[#00C170]" : "text-gray-500"
                                                                    } my-2`}
                                                                >
                                                                    {j.title}{" "}
