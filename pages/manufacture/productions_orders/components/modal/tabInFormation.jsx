                            ...
                            <div key={e.id} className="min-w-fit max-w-fit w-fit">
                                <div className="bg-white sticky top-0 z-10 ">
                                    <div
                                        ...
                                        className={` text-xs flex items-start py-2 px-4 gap-2 ${e.show ? "bg-blue-500 text-white" : "bg-gray-50"} hover:bg-blue-500 hover:text-white transition-all duration-150 ease-linear border rounded-md w-fit cursor-pointer`}
                                    >
