                                ...
                                {e.showChild &&
                                    e.arrListData.map((i, index) => (
                                        <div
                                            ...
                                            className={`grid grid-cols-12 ${isState.dataModal.id == i.id ? "bg-gray-100" : ""} items-center col-span-12 group hover:bg-gray-100 cursor-pointer transition-all duration-150 ease-in-out
