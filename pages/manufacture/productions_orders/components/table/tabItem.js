                                    ...
                                    {e.showChild &&
                                        e.arrListData.map((i, index) => (
                                            <div
                                                ...
                                                className={`grid grid-cols-12 items-center col-span-12 group hover:bg-gray-100 cursor-pointer transition-all duration-150 ease-in-out
                                            ...
                                            >
                                                <h4 className="col-span-4 text-[#344054] font-normal text-xs flex items-center py-2 px-4 gap-2">
                                                    ...
                                                    <div className="flex flex-col gap-0.5">
                                                        <h1 className="text-[#000000] group-hover:text-[#0F4F9E] font-semibold xl:text-sm text-xs">
                                                            {i.name}
                                                        </h1>
                                                ...
                                                <h4 className="col-span-5 flex items-center text-center text-[#344054] font-normal xl:text-sm text-[11px] uppercase">
                                                    {i.processBar.map((j, JIndex) => {
                                                        return (
                                                            <div key={j.id} className="flex flex-col w-full items-start">

                                                                <p className={`${j.active ? "text-[#0BAA2E]" : "text-gray-500"} font-normal text-[9px]`}>
                                                                ...
                                                                <li className={`${JIndex == i.processBar.length - 1 ? 'flex w-full relative text-gray-900 '
                                                                    :
                                                                    `flex w-full relative text-gray-900  after:content-[''] after:w-full after:h-0.5 ${j.active ? 'after:bg-[#00C170]' : 'after:bg-gray-500'}   after:inline-block after:absolute after:top-1 after:left-8`}`}
                                                                >
                                                                    <div className="block whitespace-nowrap z-10">
                                                                        <span className={`w-[10px] h-[10px]  border-2  ${j.active ? 'bg-[#00C170] border-[#00C170]' : 'bg-gray-500 border-gray-500'} rounded-full flex justify-center items-center mx-auto mb-2 text-sm`}></span>
