...
const Index = (props) => {
    ...
    }, [limit, router.query?.page, isState.idCategoryError, isState.idBranch]);
    ...
    const paginate = (pageNumber) => {
        router.push({
            pathname: "/manufacture/category_detail_errors",
    ...
    const _HandleOnChangeKeySearch = debounce(({ target: { value } }) => {
        ...
        router.replace("/manufacture/category_detail_errors");
        queryState({ onFetching: true });
    }, 500);
