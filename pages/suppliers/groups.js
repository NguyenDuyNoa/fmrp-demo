              ...
              <div className="space-y-2 2xl:h-[95%] h-[92%] overflow-hidden">
                <div className="xl:space-y-3 space-y-2">
                    ...
                    <div className='flex gap-2'>
                        ...
                        <div className="flex space-x-2 items-center">
                            {
                          data_ex?.length > 0 &&(
                            <ExcelFile filename="Nhóm nhà cung cấp" title="Nncc" element={
                ...
                <div className="xl:w-[100%] w-[110%] pr-2 ">
                    <div className="flex items-center sticky top-0 bg-white p-2 z-10">
                      <h4 className="xl:text-[14px] text-[12px] px-2 text-[#667085] uppercase w-[50%] font-[300] text-left">{dataLang?.suppliers_groups_name}</h4>
                      <h4 className="xl:text-[14px] text-[12px] px-2 text-[#667085] uppercase w-[30%] font-[300] text-left">{dataLang?.client_list_brand}</h4>
                        ...
                        <>
                          ...
                          {(data?.map((e) => 
                            <div className="flex items-center py-1.5 px-2 hover:bg-slate-100/40 " key={e.id.toString()}>
                              ...
                              <h6 className="xl:text-base text-xs  px-2 py-3 w-[30%]  rounded-md  "><span className="flex flex-wrap gap-2">{e?.branch?.map(e => (<span key={e.id} className="mb-1 w-fit xl:text-base text-xs px-2 text-[#0F4F9E] font-[300] py-0.5 border border-[#0F4F9E] rounded-lg">{e.name}</span>))}</span></h6>
      ...
      <div className="w-96 mt-4">
        <form onSubmit={_HandleSubmit.bind(this)}>
          ...
          <div className="flex flex-wrap justify-between">
                    <label className="text-[#344054] font-normal text-sm mb-1 ">{props.dataLang?.suppliers_groups_name}<span className="text-red-500">*</span></label>
                    <input
                      value={name}                
                      onChange={_HandleChangeInput.bind(this, "name")}
                      name="fname"                      
                      type="text"
                      className={`${errInput ? "border-red-500" : "focus:border-[#92BFF7] border-[#d0d5dd]"} placeholder:text-slate-300 w-full bg-[#ffffff] rounded text-[#52575E] font-normal p-2 border outline-none mb-2`}
                    />
