...
const FormContact = ({ dataLang, e, _OnChangeOption, _HandleDelete }) => {
    ...
    return (
        <div className="" key={e?.idFe?.toString()}>
            <label className="text-[#344054] font-normal text-sm mb-1 ">{dataLang?.suppliers_supplier_fullname}</label><span className="text-red-500 px-1">*</span>
            <input
                value={e.full_name}
                ...
                name="optionVariant"
                type="text"
                className={`${e.full_name == '' ? "border-red-500" : ""} focus:border-[#92BFF7]  disabled:bg-gray-300 border-[#d0d5dd] placeholder:text-slate-300 w-full bg-[#ffffff] rounded-[5.5px] text-[#52575E] font-normal p-1.5 border outline-none mb-2`}
            />
            <label className="text-[#344054] font-normal text-sm mb-1 ">{dataLang?.suppliers_supplier_phone}</label> <span className="text-red-500 px-1">*</span>
            <input
                // disabled={e?.idBe && !e?.disble}
                ...
                name="fname"
                type="number"
                className={`${e.phone_number == '' ? "border-red-500" : ""} focus:border-[#92BFF7]  disabled:bg-gray-300 border-[#d0d5dd] placeholder:text-slate-300 w-full bg-[#ffffff] rounded-[5.5px] text-[#52575E] font-normal p-1.5 border outline-none mb-2`}
            />
