...
const Index = (props) => {
    ...
    const _ServerFetching =  () => {
        Axios("GET", "/api_web/api_supplier/contact/?csrf_protection=true", {
            params: {
                search: keySearch,
                limit: limit,
    ...
    useEffect(() => {
        onFetching && _ServerFetching() || onFetching && _ServerFetching_brand()  || onFetching && _ServerFetching_Supplier()
      }, [onFetching]);
    useEffect(() => {
    ...
    const multiDataSet = [
      {
          columns: [
              ...
              {title: `${dataLang?.suppliers_contacts_name}`, width: {wpx: 100}, style: {fill: {fgColor: {rgb: "C7DFFB"}}, font: {bold: true}}},
              {title: `${dataLang?.suppliers_contacts_fullname}`, width: {wch: 40}, style: {fill: {fgColor: {rgb: "C7DFFB"}}, font: {bold: true}}},
              {title: `${dataLang?.suppliers_contacts_phone}`, width: {wch: 40}, style: {fill: {fgColor: {rgb: "C7DFFB"}}, font: {bold: true}}},
              {title: `${dataLang?.suppliers_contacts_pos}`, width: {wch: 40}, style: {fill: {fgColor: {rgb: "C7DFFB"}}, font: {bold: true}}},
              {title: `${dataLang?.suppliers_contacts_address}`, width: {wch: 40}, style: {fill: {fgColor: {rgb: "C7DFFB"}}, font: {bold: true}}},
              ...
              <div className="space-y-2 2xl:h-[95%] h-[92%] overflow-hidden">    
                <div className="xl:space-y-3 space-y-2">
                    ...
                    <div className='flex gap-2'>
                     ...
                     {
                      data_ex?.length > 0 &&(
                        <ExcelFile filename="Danh liên hệ nhà cung cấp" title="Dslhncc" element={
                ...
                <div className="min:h-[500px] 2xl:h-[90%] xl:h-[69%] h-[100%] max:h-[800px]  overflow-auto pb-2 scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-slate-100">
                  <div className="pr-2 w-[100%] lx:w-[110%] ">
                    <div className="flex items-center sticky top-0 bg-white p-2 z-10">
                      ...
                      <h4 className="xl:text-[14px] text-[12px] px-2 text-[#667085] uppercase w-[20%] font-[300] text-left">{dataLang?.suppliers_contacts_fullname}</h4>
                      <h4 className="xl:text-[14px] text-[12px] px-2 text-[#667085] uppercase w-[15%] font-[300] text-center">{dataLang?.suppliers_contacts_phone}</h4> 
                      <h4 className="xl:text-[14px] text-[12px] px-2 text-[#667085] uppercase w-[15%] font-[300] text-left">{dataLang?.suppliers_contacts_email}</h4>
                      <h4 className="xl:text-[14px] text-[12px] px-2 text-[#667085] uppercase w-[15%] font-[300] text-left">{dataLang?.suppliers_contacts_pos}</h4>
                      <h4 className="xl:text-[14px] text-[12px] px-2 text-[#667085] uppercase w-[15%] font-[300] text-left">{dataLang?.suppliers_contacts_address}</h4>
                    ...
                    {onFetching ?
                      ...
                      (<>
                          ...
                          {(data?.map((e) => 
                            <div className="flex items-center py-1.5 px-2 hover:bg-slate-100/40 " key={e.supplier_contact_id.toString()}>
                              <h6 className="xl:text-base text-xs  px-2 py-0.5 w-[15%]  rounded-md text-left">{e.supplier_name }</h6>                
