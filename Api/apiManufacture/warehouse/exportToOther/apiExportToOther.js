...
const apiExportToOther = {
    ...
    async apiExportOtherCombobox() {
        const response = await axiosCustom('GET', `/api_web/Api_export_other/exportOtherCombobox/?csrf_protection=true`,);
        return response.data
    },
    ...
    async apiAjaxWarehouseCombobox(pram) {
        const response = await axiosCustom('POST', `/api_web/Api_export_other/exportOtherCombobox/?csrf_protection=true`, pram);
        return response.data
    },
    ...
    async apiItemComboboxExportToOther(param) {
        const response = await axiosCustom('GET', `/api_web/Api_export_other/itemCombobox/?csrf_protection=true`, param);
        return response.data
    },
    async apiAjaxItemComboboxExportToOther(data) {
        const response = await axiosCustom('POST', `/api_web/Api_export_other/itemCombobox/?csrf_protection=true`, data);
        return response.data
    },
    ...
    async apiObjectListComboboxExportToOther(param) {
