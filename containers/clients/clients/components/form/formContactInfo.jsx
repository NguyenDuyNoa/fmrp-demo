                ...
                <div className="w-full p-3 pt-0">
                    <div className="" key={option.idFe?.toString()}>
                        ...
                        <input
                            ...
                            className={`${option.phone_number == '' ? "border-red-500" : ""} focus:border-[#92BFF7]  disabled:bg-gray-300 border-[#d0d5dd] placeholder:text-slate-300 w-full bg-[#ffffff] rounded-[5.5px] text-[#52575E] font-normal p-1.5 border outline-none mb-2`}
                        />
                        ...
                        <textarea
                            ...
                            type="text"
                            placeholder="Địa chỉ"
                            className="focus:border-[#92BFF7]  disabled:bg-gray-100 placeholder:text-xs border-[#d0d5dd] placeholder:text-slate-300 w-full min-h-[90px] max-h-[200px] bg-[#ffffff] rounded-[5.5px] text-[#52575E] font-normal p-2 border outline-none mb-2"
                        />
                    </div>
