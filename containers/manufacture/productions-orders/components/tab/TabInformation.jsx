        ...
        <div className='space-y-4'>
                                    ...
                                    <div />
                                    {
                                        ...
                                        (limit < dataItemOrderDetail?.items_semi.length) && (
                                            <div className=" flex justify-center py-2">
                                                <button onClick={() => setLimit(dataItemOrderDetail?.items_semi.length)} className="flex items-center gap-2 text-[#667085] 3xl:text-base text-sm hover:underline">
            ...
            <section id="section-list-comment" ref={commentTopRef} className='flex flex-col gap-4'>
                <div className='flex items-center gap-2'>
                    ...
                    <p className='3xl:text-xl text-lg text-[#003DA0] font-medium'>
                        Thảo luận
                    </p>
                </div>
