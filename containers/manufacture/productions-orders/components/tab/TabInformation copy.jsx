...
const TabInformation = () => {
    ...
    const { isOpen: isOpenSheet } = useSheet()
        ...
        <div className='flex items-start gap-4'>
            ...
            <div className='w-[75%]'>
                ...
                >
                    ...
                    {/* body */}
                    {
                        dataItemOrderDetail?.items_semi && dataItemOrderDetail?.items_semi?.slice(0, visibleProducts[dataItemOrderDetail?.id] || 4)?.map((product, index) => (
                            <div
                                key={`product-${index}`}
