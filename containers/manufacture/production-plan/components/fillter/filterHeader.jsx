...
const FilterHeader = ({ onChangeValue, _HandleSeachApi, isValue, isData, options, dataLang, typeScreen }) => {
        ...
        <>
            {
                typeScreen == 'mobile'
                    ...
                    <div className="grid items-center grid-cols-4 gap-2 ">
                        ...
                        <div className="col-span-2">
                            <h3 className="text-xs text-[#051B44] font-medium ml-1">{dataLang?.productions_orders_popup_finished_product || 'productions_orders_popup_finished_product'}</h3>
                            <SelectComponent
                                isClearable={true}
                        ...
                        <div className="col-span-2">
                            <h3 className="text-xs text-[#051B44] font-medium ml-1">{dataLang?.production_plan_form_materials_status_plan || 'production_plan_form_materials_status_plan'}</h3>
                            <SelectComponent
                                isClearable={true}
