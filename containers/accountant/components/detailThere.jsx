                                            ...
                                            <div className="flex flex-wrap items-center justify-center gap-2">
                                                {
                                                    ...
                                                    ||
                                                    (data?.status_pay === "spent_part" && (<TagColorOrange className={'!py-1'} name={`Chi 1 phần (${formatNumber(data?.amount_paid)})`} />))
                                                    ||
                                                    (data?.status_pay === "spent" && (<TagColorLime name={'Đã chi đủ'} />))
                                                }
                                            </div>
                                        </div>
                                        <div className="grid grid-cols-2 my-4 font-medium">
                                                ...
                                                {data?.items?.map((e) => (
                                                    ...
                                                    >
                                                        ...
                                                        <h6 className="text-[13px] font-medium   py-0.5 col-span-1 text-left ml-3.5">
                                                            {e?.note != undefined ? (<ExpandableContent content={e?.note} />) : ("")}
                                                        </h6>
                                                    </div>
                                                )
                                                )}
                                ...
                                <Customscrollbar className="min:h-[170px] h-[72%] max:h-[100px]">
                                    ...
                                    <div className="grid grid-cols-8  min-h-[170px] px-2">
                                        ...
                                        <div className="col-span-2 mx-auto">
                                            ...
                                            <div className="flex flex-wrap items-center justify-start gap-2">
                                                {
                                                    (data?.import_status === "not_stocked" && (<TagColorSky className={'!py-1'} name={props.dataLang[data?.import_status] || data?.import_status} />))
                                                    ||
                                                    (data?.import_status === "stocked_part" && (<TagColorOrange className={'!py-1'} name={props.dataLang[data?.import_status] || data?.import_status} />))
                                                    ||
                                                    (data?.import_status === "stocked" && (<TagColorLime className={'!py-1'} name={props.dataLang[data?.import_status] || data?.import_status} />))
                                                }
                                            </div>
                                            <div className="my-4 font-medium text-[13px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        {onFetching ? (
                                            ...
                                            <Customscrollbar className="min-h-[90px] max-h-[100px] 2xl:max-h-[250px]">
                                ...
                                <Customscrollbar className="min:h-[170px] h-[72%] max:h-[100px]">
                                    ...
                                    <div className="grid grid-cols-8  min-h-[140px] p-2">
                                        ...
                                        <div className="col-span-2 mx-auto">
                                            ...
                                            <div className="flex flex-wrap items-center justify-start gap-2">
                                                {
                                                    (data?.order_status?.status === "purchase_ordered" && (<TagColorSky className={'!py-1'} name={props.dataLang[data?.order_status?.status]} />))
                                                    ||
                                                    (data?.order_status?.status === "purchase_portion" && (<TagColorOrange className={'!py-1'} name={`${props.dataLang[data?.order_status?.status]} (${data?.order_status?.count})`} />))
                                                    ||
                                                    (data?.order_status?.status === "purchase_enough" && (<TagColorLime className={'!py-1'} name={`${props.dataLang[data?.order_status?.status]} (${data?.order_status?.count})`} />))
                                                }
                                            </div>
                                        </div>
                                        <div className="col-span-3 ">
                                    ...
                                    <div className="pr-2 w-[100%] lx:w-[110%] ">
                                        ...
                                        {onFetching ? (
                                            ...
                                            <Customscrollbar className="min-h-[90px] max-h-[200px] 2xl:max-h-[166px]" >
                                                <div className="divide-y divide-slate-200 min:h-[200px] h-[100%] max:h-[300px]">
                                                    {data?.items?.map((e) => (
                                                        <div
                                    ...
                                    <div className="grid grid-cols-8  min-h-[170px] px-2">
                                        <div className="col-span-3">
                                            ...
                                            <div className="grid grid-cols-2 my-4 font-semibold">
                                                ...
                                                <h3 className=" text-[13px]  font-medium">
                                                    {data?.delivery_date != null ? formatMoment(data?.delivery_date, FORMAT_MOMENT.DATE_TIME_SLASH_LONG) : ""}
                                                </h3>
                                            </div>
                                            <div className="grid grid-cols-2 my-4 font-semibold">
                                                <h3 className=" text-[13px] ">
                        ...
                        <div className="flex flex-col pb-1 overflow-auto customsroll scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-slate-100">
                            ...
                            <div className="grid grid-cols-12 min-h-[100px]">
                                ...
                                <div className="col-span-4 ">
                                    <div className="grid grid-cols-6 my-3 font-medium xl:my-4">
                                        <h3 className="3xl:text-[14px] 2xl:text-[13px] xl:text-[12px] text-[11px] col-span-2">
                                            {props.dataLang?.sales_product_staff_in_charge || "sales_product_staff_in_charge"} :
                                        </h3>
