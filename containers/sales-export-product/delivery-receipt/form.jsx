...
import { useClientComboboxByFilterBranch } from "@/hooks/common/useClientComboboxByBranch";
...
const DeliveryReceiptForm = (props) => {
    ...
    const { data: dataItems } = useDeliveryReceipItemAll({ "filter[order_id]": idProductOrder !== null ? +idProductOrder.value : null, "filter[delivery_id]": id ? id : "", })
                ...
                switch (type) {
                    ...
                    case "increase":
                        ...
                        if (+ce.quantity === +ce?.warehouse?.qty) {
                            isShow("error", `Số lượng chỉ được bé hơn hoặc bằng ${formatNumber(+ce?.warehouse?.qty)} số lượng tồn kho`, 3000);
                        } else if (+ce.quantity === quantityAmount) {
                            isShow("error", `Số lượng chỉ được bé hơn hoặc bằng ${formatNumber(quantityAmount)} số lượng chưa giao`, 3000);
    ...
    const _HandleSubmit = (e) => {
        ...
        const hasNullQuantity = listData.some((item) => item.child?.some((childItem) => childItem.quantity === null || childItem.quantity === "" || childItem.quantity == 0));
        const hasNullPrice = listData.some((item) => item.child?.some((childItem) => childItem.price === null || childItem.price === "" || childItem.price == 0));
                            ...
                            <div className="grid grid-cols-12  gap-3 items-center mt-2">
                                ...
                                <div className="col-span-3">
                                    ...
                                    <Select
                                        ...
                                        className={`${errBranch ? "border-red-500" : "border-transparent"} placeholder:text-slate-300 w-full z-30 bg-[#ffffff] rounded text-[#52575E] font-normal outline-none border `}
                                        isSearchable={true}
                                        style={{
                                            border: "none",
                                            boxShadow: "none",
                                ...
                                <div className="col-span-3">
                                    ...
                                    <Select
                                        ...
                                        hideSelectedOptions={false}
                                        isClearable={true}
                                        className={`${errClient ? "border-red-500" : "border-transparent"} placeholder:text-slate-300 w-full  bg-[#ffffff] rounded text-[#52575E] font-normal outline-none border `}
                                        isSearchable={true}
                                ...
                                <div className="col-span-3">
                                    ...
                                    <Select
                                        ...
                                        className={`${errProductOrder ? "border-red-500" : "border-transparent"} placeholder:text-slate-300 w-full z-20  bg-[#ffffff] rounded text-[#52575E] font-normal outline-none border `}
                                        isSearchable={true}
                                        style={{
                                            border: "none",
                                            boxShadow: "none",
                                                                ...
                                                                <div className="p-1 border-t border-l  flex flex-col col-span-2 justify-center h-full">
                                                                    <Select
                                                                        ...
                                                                        className={`${(errWarehouse && ce?.warehouse == null) ||
                                                                            (errWarehouse && (ce?.warehouse?.label == null || ce?.warehouse?.warehouse_name == null)) ? "border-red-500 border" : ""
                                                                        ...
                                                                        <InPutNumericFormat
                                                                            ...
                                                                            isAllowed={(values) => {
                                                                                ...
                                                                                if (newValue > +ce?.warehouse?.qty) {
                                                                                    isShow("error", `Số lượng chỉ được bé hơn hoặc bằng ${formatNumber(+ce?.warehouse?.qty)} số lượng tồn kho`);
                                                                                    return;
                                                                                } else if (newValue > quantityAmount) {
                                                                                    isShow("error", `Số lượng chỉ được bé hơn hoặc bằng ${formatNumber(quantityAmount)} số lượng chưa giao`);
                                                                                    return;
                                                                                }
                                                                                return true;
                                                                            }}
