// Báo cáo thời gian sản xuất theo đơn hàng
...
const TimeOrderProduction = (props) => {
    ...
    return (
        <React.Fragment>
            <Head>
                <title>Báo cáo thời gian sản xuất theo đơn hàng</title>
            </Head>
                                            ...
                                            <div className=" min:h-[400px] h-[100%] w-full max:h-[600px]  ">
                                                {isState.data?.map((e) => (
                                                    <RowTable gridCols={13} key={e.id.toString()}>
                                                        ...
                                                        <RowItemTable colSpan={5} textAlign={"right"}></RowItemTable>
...
export default TimeOrderProduction;
