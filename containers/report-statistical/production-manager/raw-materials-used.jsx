...
const RawMaterialsUsed = (props) => {
    ...
    return (
        <React.Fragment>
            <Head>
                <title>Báo cáo nguyên liệu sử dụng</title>
            </Head>
                                ...
                                <div className="3xl:h-[620px] 2xl:max-h-[550px] 2xl:h-[550px] max-h-[550px] h-[550px] overflow-auto pb-2 scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-slate-100">
                                    <div className={`2xl:w-[100%] pr-2`}>
                                        ...
                                        <HeaderTable gridCols={13}>
                                            ...
                                            <ColumnTable colSpan={3} className="grid grid-cols-3  items-center justify-center !px-0">
                                                <ColumnTable colSpan={3} textAlign={'center'} className="border-b py-0.5">
                                                    Số lượng
                                                </ColumnTable>
