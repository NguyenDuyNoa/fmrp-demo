// Báo cáo thời gian sản xuất theo sản phẩm
...
const TimeByProduct = (props) => {
    ...
    return (
        <React.Fragment>
            <Head>
                <title>Báo cáo thời gian sản xuất theo sản phẩm</title>
            </Head>
                                            ...
                                            <div className=" min:h-[400px] h-[100%] w-full max:h-[600px]  ">
                                                {isState.data?.map((e) => (
                                                    <RowTable gridCols={12} key={e.id.toString()}>
                                                        ...
                                                        <RowItemTable colSpan={4} textAlign={"center"}></RowItemTable>
                                                        <RowItemTable colSpan={4} textAlign={"right"}></RowItemTable>
