...
const SummaryOfLiabilities = (props) => {
    ...
    return (
        <React.Fragment>
            <Head>
                <title>Báo cáo tổng hợp công nợ phải trả</title>
            </Head>
            <Container>
                {statusExprired ? (
                    <EmptyExprired />
                                ...
                                <div className="3xl:h-[620px] 2xl:max-h-[550px] 2xl:h-[550px] max-h-[550px] h-[550px] overflow-auto pb-2 scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-slate-100">
                                    <div className={`2xl:w-[100%] pr-2`}>
                                        ...
                                        <HeaderTable gridCols={14} >
                                            ...
                                            <ColumnTable colSpan={4} className="grid grid-cols-2 items-center justify-center !px-0">
                                                <ColumnTable colSpan={2} textAlign={'center'} className="border-b py-0.5">
                                                    Số dư cuối kỳ
                                                </ColumnTable>
...
export default SummaryOfLiabilities