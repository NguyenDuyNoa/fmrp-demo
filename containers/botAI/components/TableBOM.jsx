        ...
        <div className="flex flex-col gap-y-2 mt-6">
            ...
            <div className="overflow-x-auto rounded-xl border">
                <table className="min-w-full text-sm text-left border-collapse bg-[#919EAB] bg-opacity-10">
                    <thead className="bg-[#EBF5FF] text-[#141522] font-deca font-semibold text-[10px]">
                        <tr>
                            <th className="px-1 py-2 text-center w-[5%]">STT</th>
                            <th className="px-1 py-2 w-[20%] font-deca font-semibold">
                                Loại
                            </th>
                            <th className="px-1 py-2 w-[20%] font-deca font-semibold">
                                Tên nguyên vật liệu
                            </th>
                            <th className="px-1 py-2 w-[10%] font-deca font-semibold">
                                Định mức
                            </th>
                            <th className="px-1 py-2 w-[15%] font-deca font-semibold">
                                Đơn vị tính
                            </th>
                            <th className="px-[2px] py-2 w-[10%] font-deca font-semibold">
                                % hao hụt
                            </th>
                            <th className="px-1 py-2 w-[20%] font-deca font-semibold">
                                Công đoạn sử dụng
                                            ...
                                            <tbody>
                                                <tr className="relative">
                                                    <td className="w-[5%] relative z-0 px-1 py-2">
                                                        <div className="absolute left-3 top-[-40px] h-[65px] w-full border-l-2 border-b-2 rounded-bl-lg border-[#C7C7CC]"></div>
                                                    </td>
