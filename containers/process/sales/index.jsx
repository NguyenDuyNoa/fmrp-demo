    ...
    return (
        <React.Fragment>
            ...
            <div className="3xl:px-10 3xl:pt-16 3xl:pb-3 2xl:pt-[70px] xl:px-10 px-3 pt-16 pb-3 space-y-1 lg:h-screen overflow-hidden flex flex-col justify-between">
                <div className="px-2 py-4 space-y-2 overflow-hidden">
                    {statusExprired ? (
                    ...
                    <h2 className="text-xl font-normal text-gray-600 3xl:text-3xl 2xl:text-2xl xl:text-2xl lg:text-2xl">
                ...
                <div className="3xl:h-[100%] 2xl:h-[100%] xl:h-[100%] lg:h-[84%] w-[100%] 3xl:px-[55px] 3xl:py-10 2xl:px-12 2xl:py-1 lg:py-2 lg:px-10 relative border-2 border-slate-100 overflow-hidden flex-col flex">
                    <div className="relative z-10 flex flex-row w-full h-full px-6 rounded-lg 3xl:px-10 2xl:px-6 xl:space-y-1 lg:space-y-1">
                        <div className="basis-full">
                            <div className="grid grid-cols-12">
                                        ...
                                        <div className="relative flex">
                                            <div className="3xl:w-[70px] 3xl:h-[80px] 2xl:w-[50px] 2xl:h-[60px] xl:w-[40px] xl:h-[55px] lg:w-[35px] lg:h-[45px] relative ">
                                                ...
                                                <img
                                                    ...
                                                    className="absolute -translate-x-1/2 top-1/2 left-1/2"
                                                />
                                            </div>
                                        ...
                                        <div className="flex items-center  w-full space-x-4  3xl:space-x-5 2xl:space-x-5 xl:space-x-4 lg:space-x-2.5">
                                            <div className="3xl:w-[25%] 3xl:h-[2px] 2xl:w-[21%] 2xl:h-[2px] xl:w-[21%] xl:h-[2px]  lg:w-[21%] lg:h-[2px]  bg-[#D0D5DD] relative">
                                                <ArrowUp2
                                                    size="32"
                                                    color="#D0D5DD"
                                                    className="absolute top-0 right-0 rotate-90 translate-x-1/2 -translate-y-1/2 3xl:scale-100 2xl:scale-75 xl:scale-75 lg:scale-50"
                                                />
                                            </div>
                                    ...
                                    <div className="flex flex-col ml-[35px]">
                                        <div className="border-l-2 border-t-2 rounded-tl-[40px] border-[#32C100] w-full 3xl:h-[73px] 2xl:h-[36px] xl:h-[20px] lg:h-[41px] relative">
                                            <ArrowUp2
                                                size="32"
                                                color="#32C100"
                                                className="absolute top-0 right-0 rotate-90 translate-x-1/2 -translate-y-1/2 3xl:scale-100 2xl:scale-75 xl:scale-50 lg:scale-50"
                                            />
                                        ...
                                        <div className="flex items-center w-full gap-2">
                                            ...
                                            <div className=" bg-[#F7DA3F] rounded mt-2 3xl:w-[20%] 2xl:w-[40%] xl:w-[38%] lg:w-[60%]">
                                                <div className="grid grid-cols-12 py-2 pl-2 ">
                                                    ...
                                                    <div className="col-span-11 p-2 text-center 3xl:text-base 2xl:text-sm xl:text-xs lg:text-xs">
                                                        Giữ kho
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div className="flex ml-[35px] w-[90%]">
                                        <div className="border-l-2 border-b-2 rounded-bl-[40px] border-[#EE1E1E] w-[40%] 3xl:h-[170px] 2xl:h-[130px] xl:h-[130px] lg:h-[95px] relative">
                                            <ArrowUp2
                                                size="32"
                                                color="#EE1E1E"
                                                className="absolute bottom-0 right-0 rotate-90 translate-x-1/2 translate-y-1/2 3xl:scale-100 2xl:scale-75 xl:scale-50 lg:scale-50"
                                            />
                                        ...
                                        <div className="relative flex left-4">
                                            <div className="">
                                ...
                                <div className="col-span-1 max-h-14">
                                    <div className="ml-4">
                                        <div className="inline-block  bg-lime-200">
                                            <div className="grid grid-cols-6 pl-1 pr-1 3xl:py-1 2xl:py-1 xl:py-1 lg:py-1 ">
                                                <div className="col-span-1 p-0">
                                                    <div className="w-4 h-4  bg-lime-600 text-white rounded-full text-center text-[10px] ">
                                                        1
                                                    </div>
                                                </div>
                                                <div className="col-span-5 p-2 text-center 3xl:text-base 2xl:text-sm xl:text-xs lg:text-xs ">
                                                    Giao hàng
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="grid grid-cols-5 col-span-5">
                                    ...
                                    <div className="relative grid items-center grid-cols-9 col-span-2 -top-2">
                                    ...
                                    <div className="relative grid items-center grid-cols-4 col-span-2 gap-2 mb-4 ml-2">
                                ...
                                <div className="grid grid-cols-5 col-span-7"></div>
                                <div className="grid grid-cols-9 col-span-5">
