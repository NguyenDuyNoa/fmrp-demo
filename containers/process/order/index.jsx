        ...
        <React.Fragment>
            ...
            <div className="3xl:px-10 3xl:pt-16 3xl:pb-3 2xl:pt-[70px] xl:px-10 px-3 pt-16 pb-3 space-y-1 lg:h-screen overflow-hidden flex flex-col justify-between">
                <div className="px-2 py-4 space-y-2 overflow-hidden">
                    ...
                    <h2 className="text-xl font-medium 3xl:text-3xl 2xl:text-2xl xl:text-2xl lg:text-2xl">
                        Quy Trình Mua Hàng - Nhập Kho
                    </h2>
                </div>

                <div className="h-[100%] w-[100%] pt-8 relative border border-slate-100 flex-col flex">
                    <div className="relative z-10 flex flex-col justify-between w-full h-full rounded-lg 3xl:px-14 2xl:px-9 xl:px-8 lg:px-4">
                        <div className="flex flex-row items-center justify-start w-full h-full gap-2 3xl:ml-16 2xl:ml-0 xl:ml-5 xl:pb-16 lg:pb-32">
                            ...
                            <div className="relative flex items-center justify-center space-x-3 border-none">
                                <button
                                    type="button"
                                    onClick={() => router.push("/purchase-order/purchases?tab=")}
                            ...
                            <div className="relative flex justify-center space-x-3items-center">
                                <button
                                    type="button"
                                    onClick={() => router.push("/purchase-order/order?tab=all")}
                            ...
                            <div className="relative flex justify-center space-x-3items-center">
                                <button
                                    onClick={() => router.push("/purchase-order/import?tab=all")}
